								...
								<div class="accordion__body">
									<div class="paymentinfo">
										<div class="single-method">
											...
											&nbsp;&nbsp;Momo <input type="radio" name="payment_type" value="momo" required/>
										</div>
									</div>
								</div>
			...
			<div class="col-md-4">
				<div class="order-details">
					...
					<div class="order-details__item">
						...
						foreach($_SESSION['cart'] as $key=>$val) {
						foreach($val as $key1=>$val1) {
							$resAttr=mysqli_fetch_assoc(mysqli_query($con,"select product_attributes.*,
								color_master.color,size_master.size from product_attributes 
					...
					<div class="ordre-details__total bilinfo">
						<input type="textbox" id="coupon_str" class="coupon_style coupon_style_fix mr5"/>
			...
			jQuery.ajax({
				...
				success:function(result) {
					...
					if(data.is_error=='no') {
						...
						jQuery('#coupon_box').css("display","flex");
						jQuery('#coupon_price').html(formatCash(data.dd.toString()));
						jQuery('#order_total_price').html(formatCash(data.result.toString()));
					}
				}
			});
		}

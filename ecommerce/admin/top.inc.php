      ...
      <header id="header" class="header">
         <div class="top-left">
            <div class="navbar-header">
               <a class="navbar-brand" href="index.php"><img src="images/logo-tech.png" alt="Logo"></a>
               <a class="navbar-brand hidden" href="index.php"><img src="images/logo-tech-mini.png" alt="Logo"></a>

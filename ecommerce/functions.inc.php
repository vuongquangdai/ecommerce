...
function sentInvoice($con,$order_id){
								  ...
								  <table class="purchase_content" width="100%" cellpadding="0" cellspacing="0">
									...
									if($coupon_value!=''){								
									  ...
									  <td width="20%" class="purchase_footer" valign="middle">
										<p class="f-fallback purchase_total">'.formatMoney($coupon_value).' đ</p>
									  </td>
									</tr>';
									}
					...
					<table class="email-footer" align="center" width="570" cellpadding="0" cellspacing="0" role="presentation">
					  <tr>
						<td class="content-cell" align="center">
						  <p class="f-fallback sub align-center">&copy; 2023 Tech.One - All rights reserved.</p>
	...
	$mail->SMTPSecure="tls";
	$mail->SMTPAuth=true;
	$mail->Username="daib2016954@student.ctu.edu.vn";
	$mail->Password="shcrnrlybqpgizbk";
	$mail->SetFrom("daib2016954@student.ctu.edu.vn");

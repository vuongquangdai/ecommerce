...
$meta_title="Niên luận cơ sở ngành";
$meta_desc="Niên luận cơ sở ngành";
$meta_keyword="Niên luận cơ sở ngành";
$meta_url=SITE_PATH;
$meta_image="";
...
<head>
	...
	<link rel="icon" type="image/x-icon" href="media/banner/logo-tech-mini.png">
				...
				<div class="row">
					<div class="menumenu__container clearfix">
						<div class="col-lg-2 col-md-2 col-sm-3 col-xs-5"> 
							<div class="logo">
								<a href="index.php"><img src="images/logo/logo-tech.png" alt="logo images"></a>
							</div>
						</div>
											...
											<div class="collapse navbar-collapse" id="navbarSupportedContent">
												<ul class="navbar-nav mr-auto">
													<li class="nav-item dropdown">
														<a class="nav-link dropdown-toggle name-fix" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
